...
# !/usr/bin/env python
"""
"configs" -- Constants and configurations for Chemputer pumps and valves
========================================================================

.. module:: configs
   :platform: Windows, Unix
   :synopsis: Constants and configurations for Chemputer pumps and valves
...
This file contains a number of constants required to configure the pump and valve firmware. Those values are accessed
when writing the default configuration, and by a number of other config-related functions in the API.
